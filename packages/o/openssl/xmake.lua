package("openssl")
    ...
    add_urls("https://github.com/openssl/openssl/archive/OpenSSL_$(version).zip",
             {alias = "github", version = function (version) return version:gsub("%.", "_"):gsub("%-", "") end, excludes = "*/fuzz/*"})

    add_versions("github:1.1.1-h", "0a976b769bdb26470971a184f5263d0c3256152d5671ed7287cf17acc4698afc")
    add_versions("github:1.1.0-l", "a305d4af4b442ad61ba3d7e82905d09bfbd80424e132e10df4899d064aa47ce2")
    add_versions("github:1.0.2-u", "493f8b34574d0cf8598adbdec33c84b8a06f0617787c3710d20827c01291c09c")
